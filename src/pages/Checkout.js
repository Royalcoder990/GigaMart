  ...
  return (
    ...
    <form className='bg-white px-5 py-5 mt-12'>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 border-2 border-gray-200 border-solid px-5">
          ...
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            ...
            <p className="text-sm leading-6 text-gray-500">State:{address.state}</p>
          </div>
        </li>
      ))}
    ...
    <div className="mx-auto mt-12 bg-white max-w-7xl px-0 py-0 sm:px-6 lg:px-8">
